    ...
    init() {
        ...
        keys.forEach(key => {
            key.addEventListener('click', (e) => {
                ...
                if(key.innerHTML !== 'Shift' || key.innerHTML !== 'Ctrl' || key.innerHTML !== 'Win' || key.innerHTML !== 'Alt' || key.innerHTML !== 'Bs' || key.innerHTML !== 'Enter' || key.innerHTML !== 'Tab' || key.innerHTML !== 'Del') {
                    value += key.innerHTML;
